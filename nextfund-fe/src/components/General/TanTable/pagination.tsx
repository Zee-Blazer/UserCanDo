			...
			<div className='mt-5 w-fit ml-auto text-xs'>
				<div className='flex'>
					<button
						...
						className='mr-5 border-[1px] border-gray_2 p-2 px-4 justify-center rounded-md flex items-center gap-2 cursor-pointer disabled:cursor-not-allowed'
					>
						<ArrowLeft size={18} />
						Previous
					</button>
					...
					<button
						...
						className='ml-5 text-pry border-[1px] border-gray_2 p-2 px-4 justify-center rounded-md flex items-center gap-2 cursor-pointer disabled:cursor-not-allowed'
					>
						Next
						<ArrowRight size={18} />
					</button>
