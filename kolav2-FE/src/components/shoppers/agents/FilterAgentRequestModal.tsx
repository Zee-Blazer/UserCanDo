...
export interface FilterAgentRequestState {
  dateFrom: Date | null;
  dateTo: Date | null;
}

interface FilterAgentRequestModalProps {
  open: boolean;
  onClose: () => void;
  onFilter: (filters: FilterAgentRequestState) => void;
  initialFilters: FilterAgentRequestState;
}

const FilterAgentRequestModal = ({
  open,
  onClose,
  onFilter,
  initialFilters,
}: FilterAgentRequestModalProps) => {
  const [filters, setFilters] =
    useState<FilterAgentRequestState>(initialFilters);
  ...
  const handleInputChange = (
    field: keyof FilterAgentRequestState,
    value: any
  ) => {
    setFilters((prev) => ({
      ...prev,
...
export default FilterAgentRequestModal;
