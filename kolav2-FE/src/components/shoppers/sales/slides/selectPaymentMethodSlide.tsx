...
const SelectPaymentMethodSlide = () => {
  const {
    prevSlide,
  ...
  const handleSelectPaymentMode = (paymentMode: string) => {
      ...
      <div className="bg-white w-full max-w-3xl mx-auto px-10 py-8 rounded-3xl shadow-[0px_8px_16px_0px_#00000014,0px_0px_4px_0px_#0000000A]">
        ...
        <div className="space-y-4">
          {paymentModes.map((paymentMode) => (
            <div
              ...
              onClick={() => handleSelectPaymentMode(paymentMode.value)}
            ...
            >
              ...
              <div
                className={`w-6 h-6 rounded-full border border-gray-300 flex items-center justify-center ${
                  shopperProfileSaleInputs?.payment_mode ===
                    paymentMode.value && "border-pry2"
                }`}
              >
                {shopperProfileSaleInputs?.payment_mode ===
                  paymentMode.value && (
        ...
        <div className="mt-8">
          <Button
            ...
            disabled={!shopperProfileSaleInputs.payment_mode}
          >
...
export default SelectPaymentMethodSlide;
